...
(function pageSlider() {
  ...
  let teamSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__.default('#team-slider0', teamProps);
  ...
  choose.addEventListener('click', e => {
    ...
    for (let slider of document.querySelectorAll('.team__slider')) {
      ...
      if (activeSelect.dataset.id == slider.dataset.id) {
        ...
        teamSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__.default(`#team-slider${slider.dataset.id}`, teamProps);
      }
    }
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("5d7e6edeebe0982a948e")
/******/ 	})();
/******/ 	
